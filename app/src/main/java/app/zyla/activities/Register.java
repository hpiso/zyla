...
public class Register extends AppCompatActivity {
    ...
    public void Inscription(View view) {
        ...
        try {
            ...
            int gender;
            if (genderSelected.getText().equals(getResources().getString(R.string.reg_gender_man)))
                gender = 0;
            else
                gender = 1;
    ...
    private void retry() {
        Toast.makeText(getApplicationContext(), getResources().getString(R.string.reg_error_inscription), Toast.LENGTH_SHORT).show();
